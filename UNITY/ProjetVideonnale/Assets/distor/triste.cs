...
public class triste : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        destination.Render();
        destinationRender.ReadPixels(new Rect(0.0f, 0.0f, Screen.width, Screen.height), 0, 0);
    ...
    void OnGUI()
    {
        GUI.DrawTexture(new Rect(0.0f, 0.0f, Screen.width, Screen.height), destinationRender);
    }
}